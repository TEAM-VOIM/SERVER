...
public class ExplanationController implements ExplanationSwagger {
    ...
    @PostMapping(value = "")
    public SuccessResponse<PointExplanationResponse> productAnalysis(@RequestBody ImageAnalysisRequest request) {
    ...
    public SuccessResponse<DetailExplanationResponse> productDetailAnalysis(@RequestBody ImageAnalysisRequest request) {
